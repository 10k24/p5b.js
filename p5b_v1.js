...
class P5b extends P5bBase {
    ...
    _bindGlobals() {
        ...
        // const origNoLoop = this._myP5.noLoop.bind(this._myP5);
        // // Custom function for global.noLoop that captures then calls original
        // global.noLoop = () => {
        //     const pixels = this._myP5.get(0, 0, this.width, this.height);
        //     this.emit("frame", new Uint8Array(pixels.buffer));
        //     this._metrics.framesDrawn++;
        //     return origNoLoop();  // This is the original, not bound to instance
        // };

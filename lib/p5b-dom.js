...
// Node-canvas compat patches, installed only for p5 v2 (v1 never needs them).

// p5 v2 renders shapes/clip() via browser-only Path2D; polyfill it as a command
...
// p5 v2 emits HSB as CSS Color 4 percentage rgb() (e.g. rgb(100% 0% 0%)) which

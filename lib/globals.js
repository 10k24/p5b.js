// Static globals p5b binds in _bindGlobals() — single source of truth, shared
// with the eslint config so the surface is never duplicated by hand.

const noop = () => {};

// True when fn is declared with the async keyword. v1 rejects async lifecycle hooks.
